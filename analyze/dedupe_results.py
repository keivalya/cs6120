#!/usr/bin/env python
"""analyze/dedupe_results.py — drop duplicate episode records from results/*.jsonl.
...
Idempotent: a deduped tree reports 0 changes on a second run. Dry-run by default.
    ...
    python analyze/dedupe_results.py            # report only
    python analyze/dedupe_results.py --apply    # rewrite, keeping .bak alongside
"""
