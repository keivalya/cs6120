#!/usr/bin/env python3
"""analyze/kinematic_divergence.py — Kinematic trajectory divergence analysis.
...
def main():
    ...
    # Write CSV
    csv_file = REPO_ROOT / "report" / "rq3_divergence.csv"
    ...
    plt.tight_layout()
    plot_file = REPO_ROOT / "report" / "rq3_divergence.png"
