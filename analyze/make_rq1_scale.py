#!/usr/bin/env python
"""analyze/make_rq1_scale.py — RQ1.3 CSS-vs-scale table (§1, §11).

Concatenates the per-model report/rq1_causal_<model>.csv files into a single
report/rq1_causal.csv, and emits report/rq1_scale.csv: CSS(blank), CSS(nonsense),
