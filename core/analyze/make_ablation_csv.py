#!/usr/bin/env python3
"""core/analyze/make_ablation_csv.py — the word-class ablation, the paper's decisive test.
...
Writes paper/rq_ablation.csv with one row per (model, condition), including the
...
Usage: python core/analyze/make_ablation_csv.py [--suite libero_goal]
"""
