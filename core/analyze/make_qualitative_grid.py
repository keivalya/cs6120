#!/usr/bin/env python3
"""core/analyze/make_qualitative_grid.py — Qualitative Rollout Video Figure Grid Generator.

Extracts key temporal frame snapshots (e.g. t = 0, 60, 120, 180, 240, 300 steps)
from generated MP4 rollout videos in data/videos/ and composites a side-by-side
...
def main():
    ...
    plt.tight_layout()
    output_path = REPO_ROOT / "paper" / "qualitative_grid.png"
