#!/bin/env python
"""core/analyze/plot_rq2.py — publication-grade RQ2 figures. Reads paper/rq2_*.csv.

- paper/rq2_axis.png: object-axis vs action-axis ΔTSR (pp) per model.
- paper/rq2_pd_scatter.png: ΔTSR vs mean paraphrase distance (PD) per operation.
- paper/rq2_locus.png: planning vs execution failure breakdown per model and axis.
"""
