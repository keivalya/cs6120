#!/usr/bin/env python3
"""core/analyze/plot_rq4.py — Generate paper/rq4_attention.png from paper/rq4_attention.csv (RQ4).
...
def main():
    ...
    if not csv_path.exists():
        print(f"Error: {csv_path} does not exist. Build it with:\n"
              f"  <per-env python> core/analyze/attention_extract.py --model <name>   # one per env\n"
              f"  python core/analyze/attention_extract.py --merge", file=sys.stderr)
        sys.exit(1)
