#!/usr/bin/env python
"""core/analyze/pride_wrap.py — PRIDE via LIBERO-Para's own metric (CLAUDE.md §7).
...
Run directly for a quick report:
  python core/analyze/pride_wrap.py --model smolvla [--suite libero_goal]
"""
...
def pride_for_model(model, suite="libero_goal", results_root=None, axis=None,
    ...
    results_root = results_root or (REPO_ROOT / "data" / "results")
