#!/usr/bin/env python
"""core/perturb/make_instructions.py — causal-probe generator (CLAUDE.md §5).
...
core/perturb/generated/<suite>.jsonl for audit/reproducibility (§5). When a probe
...
Usage:
  python core/perturb/make_instructions.py --suite libero_goal [--seed 0]
"""
...
def main():
    ...
    out_dir = REPO_ROOT / "data" / "instructions"
