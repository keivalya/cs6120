#!/usr/bin/env python
"""core/run/preflight.py — fail-fast GPU render health check (CLAUDE.md §12).
...
(see paper/GATE3_STATUS.md). This check loads the policy + one LIBERO env and
...
Usage: python core/run/preflight.py [--obs_hw 360]
"""
