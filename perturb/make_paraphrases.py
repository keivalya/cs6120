#!/usr/bin/env python
"""perturb/make_paraphrases.py — RQ2 paraphrase-condition generator (CLAUDE.md §3,§7).
...
(analyze/pride_wrap.py, analyze/make_rq2_csv.py). Output (one row per paraphrase):
  perturb/generated/<suite>_paraphrases.jsonl
...
Usage:
  python perturb/make_paraphrases.py --suite libero_goal [--max_per_axis 15] [--seed 0]
"""
...
def main():
    ...
    out_path = REPO_ROOT / "perturb" / "generated" / f"{args.suite}_paraphrases.jsonl"
