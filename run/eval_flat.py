#!/usr/bin/env python
"""run/eval_flat.py — flat, module-level SmolVLA causal eval (CLAUDE.md §5,§7,§8).

Mirrors the proven standalone structure (report/patches/working_eval_reference.py):
...
Usage:
  python run/eval_flat.py --model smolvla --suite libero_goal \
...
# pre-fork parent state minimal, matching report/patches/working_eval_reference.py;
