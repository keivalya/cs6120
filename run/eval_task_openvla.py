...
if args.paraphrase_axis:
    ...
    # See the same block in run/eval_task.py: a requested condition with no record
...
# conditions were split across separate jobs. See run/scene_atomic.py.
...
for label, items in groups:
    ...
    # run/eval_task.py does. Episode k keeps its init state either way, so the
